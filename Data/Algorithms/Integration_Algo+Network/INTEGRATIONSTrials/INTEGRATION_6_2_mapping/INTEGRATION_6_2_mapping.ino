...
for (int i=0;i<=((Algorithm_Counter/2)-1);)  //FOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOORRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR
...

{
  ...
  if (newLeft != positionLeft || newRight != positionRight) 

        {
           ...
           Serial.print("$now");Serial.print(",");Serial.print(Xpos);Serial.print(",");Serial.print(Ypos);Serial.print(",");Serial.print(theta);
