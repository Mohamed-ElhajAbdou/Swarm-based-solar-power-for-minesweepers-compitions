...
float Bmbo[16];
float ATata[16];
float Robot_Loc[1][2]={ {5,0} };
int Algorithm_Counter;
...
//float Mines_Loc[8][2] = { {2,3},{7,6},{8,4},{5,6},{6,8},{2,9},{5,10} ,{10,10}};
...
//float Mines_Loc[8][2] = { {2,3},{7,6},{8,4},{5,6},{6,8},{2,9},{5,10} ,{10,10} };
//float Mines_Loc[15][2] ={  {1, 2}, {3, 1}, {3, 2}, {1, 5}, {5, 3}, {4, 7}, {2, 8}, {3, 8}, {2, 9}, {7, 8}, {4, 10}, {6, 9}, {5, 11}, {7, 10}, {7, 12}};
...
//Algorithm_Counter=8;
 ...
 /* recivingdata();
//Matrix.Print((float*)Mines_Loc,1,Algorithm_Counter,"Recevied in one array ");
if (Algorithm_Counter==0)
  {
    Serial.println("Sorry we need to RESET the Arduino ");
   soft_restart();
  }
kokk(Mines_Loc,Algorithm_Counter);
Serial.println(flag);
delay(1000);*/
...
{
    if ( Show_off==0)
{    Serial.println("CNOWWWWW_____1 ");

  


 //float Mines_Loc[15][2] ={ , {1, 1}, {3, 1.5}, {1, 2}, {0, 0}};//{1, 5}, {5, 3
 //less than 5 
 /*  float Mines_Loc[15][2] ={  {4, 10}, {1, 5}, {3, 5}, {2, 9},{3,8},{4,7 },{1,2},{2,8}};

 Algorithm_Counter=16;*/
 float Mines_Loc[15][2] ={  {1 ,2}, {3,1 },{1,5}, {4, 6}, {4, 10},{0,0}};
	


 Algorithm_Counter=12;
  // for ( int LED=0 ;LED<(Algorithm_Counter/2);LED++)
  ...
  Matrix.Print((float*)Mines_Loc,Algorithm_Counter,2,"Mines Locations  Of X ");Serial.print((Algorithm_Counter/2)-1);Serial.println();delay(40);

  kokk(Mines_Loc,Algorithm_Counter);

}
 if (Show_off==1)
{  Serial.println("CNOWWWWW_____2  ");
  ...
  delay(1000);
  float Mines_Loc[15][2] ={ {1, 1}, {3, 1}, {3, 2}, {1, 5}, {5, 3}, {4, 7}, {2, 8}, {3, 8}, {2, 9}, {7, 8}, {4, 10}, {6, 9}, {5, 11}, {7, 10}, {7, 12}};
  Algorithm_Counter=30; 
Matrix.Print((float*)Mines_Loc,Algorithm_Counter,2,"Mines Locations  Of X ");Serial.print((Algorithm_Counter/2)-1);Serial.println();delay(40);
...
Show_off=Show_off+1;
Serial.println(Algorithm_Counter);
}
}

void kokk(float Mines_Loc[15][2], int Algorithm_Counter )

       {    digitalWrite(12, HIGH);


  for (int i=0;i<=((Algorithm_Counter/2)-1);)
//_____________________________FOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOORRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR_________________________________
{
    flag=1;
  ...
  if(i>((Algorithm_Counter/2)-1))
{
 ...
 // ATata[i]=0;
  ...
  Atano[i]=(atan(Ayeo[i]/Axeo[i])) * val;
  Serial.println();
...
if (Axeo[i] <0 && Ayeo[i] <0 )
  ...
  if( Axeo[i]==0 && Ayeo[i]<0)
   ...
   if(Ayeo[i]==0 && Axeo[i]<0)
   {
     ...
     Serial.print("ATata___");Serial.print(Atano[i]   );Serial.print("__X_Next__");Serial.print(X_poos[i]  );Serial.print("__Y_Next__");Serial.print(Y_poos[i]  );
...

{
      if (kalo < -135 )
  {
        if ( ((kalo>(Atano[i]-2) && kalo<(Atano[i]+2)) )||(Atano[i]==kalo))
       {       
               do
                        {
                          
   long newLeft, newRight;   motorGo(0, CW, 70); motorGo(1, CW, 70);Ultra_sonic();
  ...
  if (newLeft != positionLeft || newRight != positionRight) 

        {
           ...
           theta =( kalAngleZ )   ;  
           Distance1=0.32*((positionLeft*0.2)/(333));  Distance2= 0.32*((positionRight*0.2)/(333));  
           //le
           ...
           Serial.print("$now");Serial.print(",");Serial.print(Xpos);Serial.print(",");Serial.print(Ypos);Serial.print(",");Serial.print(kalo);
          Serial.println("You Arrived_____Move_Forword");Serial.println();
           delay(60);        d=abs(Xpos-X_poos[i]);      s=abs(Ypos-Y_poos[i]);      Toleto=0.2;      }while ((d>Toleto)||(s>Toleto));
        ...
        { 
           Serial.print("$now");Serial.print(",");Serial.print(Xpos);Serial.print(",");Serial.print(Ypos);Serial.print(",");Serial.print(kalo);
              Serial.println("Move_Left_First_third"); Serial.println();       //right
  ...
  if (newLeft != positionLeft || newRight != positionRight) 
        {
          ...
          Serial.println("You Arrived_____Move_Forword");Serial.println();
           ...
           Serial.println("Move_Right_First_third");  //Left
 ...
 if (  (kalo<=-90 &&kalo>=-180)  &&  (Atano[i]>=90&&Atano[i]<=180))
  ...
  if (newLeft != positionLeft || newRight != positionRight) 
        {
           ...
           knobLeft.write(0);      knobRight.write(0);      i=i+1;motorOff(0);      motorOff(1);delay(3000);
             ...
             {  
               Serial.print("$now");Serial.print(",");Serial.print(Xpos);Serial.print(",");Serial.print(Ypos);Serial.print(",");Serial.print(kalo);
               Serial.println("Move_Left_First_Fourth");        //right
             motorGo(0, CCW, 70);  motorGo(1, CW, 70); 
  ...
  if (newLeft != positionLeft || newRight != positionRight) 
        {
           ...
           Serial.println("Move_Left_First_First");        //right
             motorGo(0, CCW, 70);  motorGo(1, CW, 70); 
                    }
           }
       if(kalo<Atano[i])
  ...
  if (newLeft != positionLeft || newRight != positionRight) 
    ...
    //error detection first first or fourth first
           ...
           Serial.println("Move_Right_First_First"); 
             motorGo(0, CW, 70); motorGo(1, CCW, 70);
  ...
  if (newLeft != positionLeft || newRight != positionRight) 
        {
           ...
           knobLeft.write(0);      knobRight.write(0);      i=i+1;motorOff(0);      motorOff(1);delay(3000);
              ...
              { 
                     Serial.print("$now");Serial.print(",");Serial.print(Xpos);Serial.print(",");Serial.print(Ypos);Serial.print(",");Serial.print(kalo);
                          Serial.println("Move_Right_First_Second");  //Left
                          motorGo(0, CW, 70); motorGo(1, CCW, 70);
...
if (  (kalo<=0 &&kalo>-90)  &&  (Atano[i]<=0 && Atano[i]>=-90))
 {
   ...
   long newLeft, newRight;   motorGo(0, CW, 70); motorGo(1, CW, 70);Ultra_sonic();
                         ...
                         if (newLeft != positionLeft || newRight != positionRight) 
        {
           ...
           Serial.println("Move_Left_Second_Second");        //right
             motorGo(0, CCW, 70);  motorGo(1, CW, 70); 
                           }
                             }
   ...
   long newLeft, newRight;   motorGo(0, CW, 70); motorGo(1, CW, 70);Ultra_sonic();
                         ...
                         if (newLeft != positionLeft || newRight != positionRight) 
        {
           ...
           Serial.println("Move_Right_Second_Second");  //Left
                }
                }
                  }
  ...
  if (  (kalo<=0 &&kalo>-90)  &&  (Atano[i]<-90 && Atano[i]>=-180))
   ...
   long newLeft, newRight;   motorGo(0, CW, 70); motorGo(1, CW, 70);Ultra_sonic();
                         ...
                         if (newLeft != positionLeft || newRight != positionRight) 
        {
           ...
           Serial.println("Move_Left_Second_First");        //right
  ...
  if ( (kalo<=0 &&kalo>-90)  &&  (Atano[i]>=90 && Atano[i]<=179))
       {   
          if(kalo<-45)
            {
...
//Move_Right_Second_Third
  ...
  motorGo(0, CW, 70); motorGo(1, CCW, 70);
           ...
           Serial.println("Move_Right_Second_Third");  //Left
...
//Move_Right_Second_Third
  ...
  motorGo(0, CW, 70); motorGo(1, CCW, 70);
           ...
           Serial.println("Move_Right_Third_Third");  //Left
  ...
  if (newLeft != positionLeft || newRight != positionRight) 
          ...
          else
    {
           ...
           Serial.println("Move_Left_Third_Third");
        //right
             motorGo(0, CCW, 70);  motorGo(1, CW, 70); 
     }   
        }
  ...
  if (newLeft != positionLeft || newRight != positionRight) 
    ...
    {  
           ...
           Serial.println("Move_Left_Third_Second");
        //right
             motorGo(0, CCW, 70);  motorGo(1, CW, 70); 
     }   
      }
 ...
 { 
  ...
  motorGo(0, CW, 70); motorGo(1, CCW, 70);
           ...
           Serial.println("Move_Right_Third_Fourth");
         }
...
if (  (kalo>90 &&kalo<=180) && (Atano[i]>0 && Atano[i]<90))
  ...
  if (newLeft != positionLeft || newRight != positionRight) 
    ...
    { 
           ...
           Serial.println("Move_Left_Fourth_Third");
        //right
             motorGo(0, CCW, 70);  motorGo(1, CW,70 ); 
     }
     }
  ...
  if (newLeft != positionLeft || newRight != positionRight) 
        {
           ...
           d=abs(Xpos-X_poos[i]);      s=abs(Ypos-Y_poos[i]);      Toleto=0.2;
  ...
  motorGo(0, CW, 70); motorGo(1, CCW, 70);
           Serial.print("$now");Serial.print(",");Serial.print(Xpos);Serial.print(",");Serial.print(Ypos);Serial.print(",");Serial.print(kalo);
             Serial.println("Move_Right_Fourth_First");
  //Left
...
arrSize = sizeof( Matix ) / sizeof( float );
Serial.print("Size of the Matrix Mines LOC ");Serial.println(arrSize/2);

/*Serial.print(Mines_Loc[0][0]  );Serial.print("\t"  );Serial.println("Mines_Loc[0][0] " );
Serial.print(Mines_Loc[0][1]  );Serial.print("\t"  );Serial.println("Mines_Loc[0][1] " );
Serial.print(Mines_Loc[1][0]  );Serial.print("\t"  );Serial.println("Mines_Loc[1][0] " );
Serial.print(Mines_Loc[1][1]  );Serial.print("\t"  );Serial.println("Mines_Loc[1][1] " );
Serial.print(Mines_Loc[2][0]  );Serial.print("\t"  );Serial.println("Mines_Loc[2][0] " );
Serial.print(Mines_Loc[2][1]  );Serial.print("\t"  );Serial.println("Mines_Loc[2][1] " );
...
for (int i=0;i<31;i=i+2)
{
        if (int (Matix[i])>5)
        {   
              Mines_Loc_Filter[G][0]= (Matix[i]);
              Mines_Loc_Filter[G][1]= (Matix[i+1]);
...
radio.stopListening();
Matrix.Print((float*)Mines_Loc,arrSize,2,"Mines_Locs ");
Matrix.Print((float*)Mines_Loc_Filter,arrSize,2,"Filtering the Location ");
...
if (Counter_while_Loop==Q&&Matix[0]==0&&Matix[1]==0)
 ...
 return ( Mines_Loc_Filter,Algorithm_Counter);
