...
if (Algorithm_Counter==0)
  {
   ...
   soft_restart();
     ...
     Serial.print("Algorithm Counter  ");
 Serial.println(Algorithm_Counter);
kokk(Mines_Loc_Filter,Algorithm_Counter);
Serial.println(Algorithm_Counter );
*/
flag =1;
if ( flag==1)
...
{    Serial.println("CNOWWWWW_____1 ");
 ...
 //float Mines_Loc[15][2] ={  {0,0},{1, 1}, {3, 1.5}, {1, 2}, {0, 0}};//{1, 5}, {5, 3}};
 // more than 5
 float Mines_Loc[15][2] ={  {6 ,4}, {7,3}, {7, 6}, {8, 7},{6,10},{5,0 }};
//float Mines_Loc[15][2] ={  {7 ,8}, {6,9 },{5,10}, {7, 8}, {7, 10},{2,0}};
// float Mines_Loc[15][2] ={  {1,2}, {3,1 },{1,5}, {5, 3}, {4, 7},{0,0}};
...
{  Serial.println("CNOWWWWW_____2  ");
  ...
  delay(1000);
  float Mines_Loc[15][2] ={ {0, 0}, {3, 1}, {3, 2}, {1, 5}, {5, 3}, {4, 7}, {2, 8}, {3, 8}, {2, 9}, {7, 8}, {4, 10}, {6, 9}, {5, 11}, {7, 10}, {7, 12}};
...
Matrix.Print((float*)Matix,(Algorithm_Counter),2,"Matix  Of X ");

Matrix.Print((float*)Mines_Loc,(Algorithm_Counter),2,"Mines Locations  Of X ");
Matrix.Print((float*)Mines_Loc_Filter,(Algorithm_Counter),2,"Mines Filtered  Of X ");
