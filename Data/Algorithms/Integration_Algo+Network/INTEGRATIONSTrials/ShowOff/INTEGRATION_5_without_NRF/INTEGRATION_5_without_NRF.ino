...
{    Serial.println("CNOWWWWW_____1 ");
 ...
 float Mines_Loc[15][2] ={  {7 ,8}, {7,0 },{6,9}, {7, 0}, {7, 10},{6,12}};
...

{
  ...
  if (newLeft != positionLeft || newRight != positionRight) 

        {
           ...
           theta =( kalAngleZ )   ;  
           Distance1=0.7*((positionLeft*0.2)/(333));  Distance2= 0.7*((positionRight*0.2)/(333));  
           //le
...
//delay(1000);// long wire 
delay(1000);// short witr 
      digitalWrite(12, LOW);
...
if (Counter_while_Loop==Q&&Matix[0]==0&&Matix[1]==0)
 ...
 return ( Mines_Loc,Algorithm_Counter);
